<?php 
    ...
    if($_SESSION['valid'] === true){
        include_once('./otherProduct/opAutoData.php');
...
<head>
    ...
    <title>Add Other Product Purchase | My Eye Care</title>
...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                OTHER PRODUCT'S PURCHASE DATA 
                                &nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#opPurAddModal">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="opPurTable">
                                    <thead>
                                        <tr>
                                            <th>S.No.</th>
                                            <th>Glass Code</th>
    ...
    <?php include('./otherProduct/opPurModel.php'); ?>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#opPurTable').DataTable({
                "responsive": true,
                "processing": true,
                "serverSide": true,
                "bJQueryUI": true,
                "ajax": {
                    url: "./otherProduct/fetchPurOPData.php"
                },
                error: function () { 
                    $(".example -error").html("");
                    $("#opPurTable").append('<tbody class="employee-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
                    $("#opPurTable").css("display", "none");
                },
                "destroy": true
            });
        });
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.upModelBtn', function(e) {
            ...
            $.ajax({
                    url: "./otherProduct/opPurValue.php",
                    type: "POST",
                    cache: false,
                    data:{
                        id: purID
