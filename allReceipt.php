                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="saleTable">
                                    <thead>
                                        <tr>
                                            <th>S.No.</th>
                                            <?php if($branch === ''){ ?>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#saleTable').DataTable({
                ...
                "bJQueryUI": true,
                "ajax": {
                    url: "./receipt/fetchSaleData.php"
                },
                error: function () { 
                    $(".example -error").html("");
                    $("#saleTable").append('<tbody class="employee-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
