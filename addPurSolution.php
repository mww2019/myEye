<?php 
    ...
    if($_SESSION['valid'] === true){
        include_once('./solution/solutionAutoData.php');
...
<head>
    ...
    <title>Add Solution Purchase | My Eye Care</title>
...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                SOLUTION'S PURCHASE DATA 
                                &nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#solutionPurAddModal">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="solutionPurTable">
                                    <thead>
                                        <tr>
                                            <th>S.No.</th>
                                            <th>Glass Code</th>
    ...
    <?php include('./solution/solutionPurModel.php'); ?>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#solutionPurTable').DataTable({
                "responsive": true,
                "processing": true,
                "serverSide": true,
                "bJQueryUI": true,
                "ajax": {
                    url: "./solution/fetchPurSolutionData.php"
                },
                error: function () { 
                    $(".example -error").html("");
                    $("#solutionPurTable").append('<tbody class="employee-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
                    $("#solutionPurTable").css("display", "none");
                },
                "destroy": true
            });
        });
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.upModelBtn', function(e) {
            ...
            $.ajax({
                    url: "./solution/solutionPurValue.php",
                    type: "POST",
                    cache: false,
                    data:{
                        id: purID
