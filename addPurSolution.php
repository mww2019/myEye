...
<head>
    ...
    <title>Add <?= ucwords($title) ?> Purchase | My Eye Care</title>
...
<body class="theme-red">
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <?php include_once('./purchase/purTableView.php') ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php include('./purchase/purchaseModal.php'); ?>
    ...
    <script src="./purchase/purchaseData.js"></script>
