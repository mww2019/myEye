<!-- Add Purchase Model -->
    <div class="modal fade" id="purAddModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">PURCHASE <?= strtoupper($title) ?></h4>
                </div>
                <hr/>
                <div class="modal-body">
                    <form method="post" action="./purchase/addPurchaseData.php">
                        <input type="hidden" name="proCat" id="proCat" value="<?= $title ?>">
                        <input type="hidden" name="protab" id="protab" value="<?= $tData ?>">
                        <?php if($branch === ''){ ?>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-3">
                            <label for="pro_code">Product Name</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="f_name" name="f_name" class="form-control" readonly placeholder="Solution Name">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
...
<!-- Update Solution Purches Model -->
    <div class="modal fade" id="purUpModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">UPDATE PURCHASE <?= strtoupper($title) ?></h4>
                </div>
                <hr/>
                <div class="modal-body">
                    <form method="post" action="./purchase/upPurchaseData.php">
                        <?php if($branch === ''){ ?>
                        <div class="col-sm-12">
                            <label for="branch">Branch</label>
                            <div class="form-group">
                        ...
                        <?php } ?>
                        <input type="hidden" name="proCat" id="edit_proCat">
                        <input type="hidden" name="purID" id="purID">
                        <input type="hidden" name="sENme" id="sENme">
                        <div class="col-sm-3">
                            <label for="code">Solution Code</label>
                            <div class="form-group">
                                <div class="form-line">
                        ...
                        <div class="col-sm-3">
                            <label for="pro_code">Solution Name</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="edit_f_name" name="f_name" class="form-control" readonly placeholder="Solution Name">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
