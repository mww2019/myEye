...
$columns = array(
    ...
    $sql = "SELECT * FROM product_purches WHERE status=1 and pro_cat='solution'";
    ...
    while ($row = mysqli_fetch_array($query)) {  
        ...
        $nestedData[] = '<button type="button" data-toggle="modal" data-target="#solutionPurUpModal" data-vendor='. $row['id'] .' class="btn btn-primary waves-effect actionBtn upModelBtn" title="Edit"><i class="material-icons">edit</i></button>';
