<!-- Add Solution Purches Model -->
    <div class="modal fade" id="solutionPurAddModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">PURCHASE SOLUTION</h4>
                </div>
                <hr/>
                <div class="modal-body">
                    <form method="post" action="./solution/addPurSolutionData.php">
                        <div class="col-sm-3">
...
<!-- Update Solution Purches Model -->
    <div class="modal fade" id="solutionPurUpModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">UPDATE PURCHASE SOLUTION</h4>
                </div>
                <hr/>
                <div class="modal-body">
                    <form method="post" action="./solution/upPurSolutionData.php">
