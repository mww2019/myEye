...
$qtyFetch = "SELECT quantity FROM product_solution WHERE code='$pro_code'"; 
...
$sqlData1 = "UPDATE product_solution SET purchase_price='$pur_price', selling_price='$sell_price', tax='$tax', quantity='$new_quantity', dte_modified='$dateTime' WHERE code='$pro_code'  ";
...
if ($conn->query($sqlData) === TRUE) { 
	...
	header("Location: ".$baseURL."addPurSolution.php");
} else {
