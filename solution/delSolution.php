...
$sql = "UPDATE product_solution SET dte_modified='$dateTime', status='0' WHERE id='$id' ";

if ($conn->query($sql) === TRUE) {
  $_SESSION['actStatus'] = "success";
  $_SESSION['actTitle'] = "Good job!";
  $_SESSION['actMsg'] = "Solution deleted successfully!";
  header("Location: ".$baseURL."addSolution.php");
} else {
  $_SESSION['actStatus'] = "error";
  $_SESSION['actTitle'] = "Oops!";
  $_SESSION['actMsg'] = "Solution not deleted!";
  header("Location: ".$baseURL."addSolution.php");
}
