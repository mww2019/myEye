<?php 
    ...
    if($_SESSION['valid'] === true){
        include_once('./lense/lenseAutoData.php');
...
<head>
    ...
    <title>Add Contact Lenses Purchase | My Eye Care</title>
...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                CONTACT LENS PURCHASE DATA 
                                &nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#lensPurAddModal">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="lensPurTable">
                                    <thead>
                                        <tr>
                                            <th>S.No.</th>
                                            <th>Frame Code</th>
    ...
    <?php include('./lense/lensPurModel.php'); ?>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#lensPurTable').DataTable({
                "responsive": true,
                "processing": true,
                "serverSide": true,
                "bJQueryUI": true,
                "ajax": {
                    url: "./lense/fetchPurLensData.php"
                },
                error: function () { 
                    $(".example -error").html("");
                    $("#lensPurTable").append('<tbody class="employee-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
                    $("#lensPurTable").css("display", "none");
                },
                "destroy": true
            });
        });
