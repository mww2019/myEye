...
if($preQF_quant == $quantity){
	...
	$qtyFetch = "SELECT quantity FROM other_products WHERE code='$pro_code'"; 
...
$sqlData1 = "UPDATE other_products SET purchase_price='$pur_price', selling_price='$sell_price', tax='$tax', quantity='$new_quantity', dte_modified='$dateTime' WHERE code='$pro_code'  ";
...
if ($conn->query($sqlData) === TRUE) { 
	...
	header("Location: ".$baseURL."addPurOtherProduct.php");
} else {
