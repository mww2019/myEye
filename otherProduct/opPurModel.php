<!-- Add Other Product Purches Model -->
    <div class="modal fade" id="opPurAddModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">PURCHASE OTHER PRODUCT</h4>
                </div>
                <hr/>
                <div class="modal-body">
                    <form method="post" action="./otherProduct/addPurOPData.php">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="f_name" name="f_name" class="form-control" readonly placeholder="Product Name">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
...
<!-- Update Other Product Purches Model -->
    <div class="modal fade" id="opPurUpModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">UPDATE PURCHASE OTHER PRODUCT</h4>
                </div>
                <hr/>
                <div class="modal-body">
                    <form method="post" action="./otherProduct/upPurOPData.php">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="edit_f_name" name="f_name" class="form-control" readonly placeholder="Product Name">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
