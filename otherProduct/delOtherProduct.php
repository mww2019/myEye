...
$sql = "UPDATE other_products SET dte_modified='$dateTime', status='0' WHERE id='$id' ";

if ($conn->query($sql) === TRUE) {
  $_SESSION['actStatus'] = "success";
  $_SESSION['actTitle'] = "Good job!";
  $_SESSION['actMsg'] = "Product deleted successfully!";
  header("Location: ".$baseURL."addOtherProduct.php");
} else {
  $_SESSION['actStatus'] = "error";
  $_SESSION['actTitle'] = "Oops!";
  $_SESSION['actMsg'] = "Product not deleted!";
  header("Location: ".$baseURL."addOtherProduct.php");
}
