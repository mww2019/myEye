...
$sqlData = "UPDATE product_goggle SET code='$pro_code', name='$goggle_name', company='$company', quality='$quality', color='$color', size='$size', type='$type', gender='$gender', shape='$shape', material='$material', purchase_price='$pur_price', selling_price='$sell_price', tax='$tax', quantity='$quantity', dte_modified='$dateTime' WHERE id='$id'  ";
