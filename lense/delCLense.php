...
$sql = "UPDATE contact_lenses SET dte_modified='$dateTime', status='0' WHERE id='$id' ";

if ($conn->query($sql) === TRUE) {
  $_SESSION['actStatus'] = "success";
  $_SESSION['actTitle'] = "Good job!";
  $_SESSION['actMsg'] = "Contact lens deleted successfully!";
  header("Location: ".$baseURL."addCLens.php");
} else {
  $_SESSION['actStatus'] = "error";
  $_SESSION['actTitle'] = "Oops!";
  $_SESSION['actMsg'] = "Contact lens not deleted!";
  header("Location: ".$baseURL."addCLens.php");
}
