...
if($resultChkCode['code'] === $pro_code) {
	...
	$sqlData = "INSERT INTO product_frame (code, name, company, quality, color, size, type, gender, shape, material) VALUES ('$pro_code', '$frame_name', '$company', '$quality', '$color', '$size', '$type', '$gender', '$shape', '$material')";
