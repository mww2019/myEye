...
$columns = array(
    ...
    $sql = "SELECT id,code FROM product_glass WHERE status=1";
    ...
    while ($row = mysqli_fetch_array($query)) {  
        ...
        $nestedData[] = '<a data-toggle="modal" data-target="#glassDetailsModal" data-vendor='. $row['id'] .' class="waves-effect actionBtn proDetails">'.$row["code"].'</a>';
